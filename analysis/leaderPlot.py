...
for thisRow in range(rowCount):
    uid = allData[thisRow,11]*10000 + allData[thisRow,10]
    if uid not in leaderID:
        continue
...
im=ax2.pcolormesh(theta2,r2,hista2,lw=0.0,vmin=0,vmax=0.01,cmap='viridis')
...
fig1.savefig("densityHMLEADER.png",bbox_inches='tight',dpi=100)
# plot the 'spine'
